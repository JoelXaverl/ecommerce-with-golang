...
import (
	...
	common "ecommerce-with-golang/pb/common"
...
type Address struct {
	...
	Provice       string                 `protobuf:"bytes,3,opt,name=provice,proto3" json:"provice,omitempty"`
...
type User struct {
	...
	Balance  float64                `protobuf:"fixed64,4,opt,name=balance,proto3" json:"balance,omitempty"` //decimal ada varian yaitu float dan double
...
const file_user_user_proto_rawDesc = "" +
	"\n" +
	"\x0fuser/user.proto\x12\x04user\x1a\x1acommon/base_response.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"j\n" +
	"\aAddress\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12!\n" +
	"\ffull_address\x18\x02 \x01(\tR\vfullAddress\x12\x18\n" +
	"\aprovice\x18\x03 \x01(\tR\aprovice\x12\x12\n" +
	...
	"\x05Login\x12\x12.user.LoginRequest\x1a\x13.user.LoginResponseB\x1fZ\x1decommerce-with-golang/pb/userb\x06proto3"
