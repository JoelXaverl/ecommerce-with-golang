...
import (
	product "ecommerce-with-golang/pb/ecommerce/product"
...
type Order struct {
	...
	Products      []*product.Product     `protobuf:"bytes,3,rep,name=products,proto3" json:"products,omitempty"` //repeated utk mendefinisikan array
